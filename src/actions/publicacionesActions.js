...
import {
	CARGANDO,ERROR, ACTUALIZAR, COM_CARGANDO, COM_ERROR, COM_ACTUALIZAR
...
export const traerComentarios = (pub_key, com_key) => async (dispatch, getState) => 
{
	...
	try {
		const respuesta = await axios.get(`https://jsonplaceholder.typicode.com/
		comments?postId=${seleccionada.id}`)
